...
class hd_tx_am_ma3_hackrf(gr.top_block):
    ...
    def __init__(self):
        ...
        self.nrsc5_sis_encoder_0 = nrsc5.sis_encoder(mode=nrsc5.pids_mode.AM, short_name='ABCD', slogan='This is ABCD-AM', message='Generated by GNU Radio', program_types=[nrsc5.program_type.NEWS], latitude=40.6892, longitude=(-74.0445), altitude=93.0, country_code='US', fcc_facility_id=0)
