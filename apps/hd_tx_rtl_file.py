...
class hd_tx_rtl_file(gr.top_block):
    ...
    def __init__(self):
        ...
        self.rational_resampler_xxx_1 = filter.rational_resampler_ccc(
                ...
                taps=[],
                fractional_bw=0)
        self.nrsc5_sis_encoder_0 = nrsc5.sis_encoder(short_name='ABCD', slogan='This is ABCD-FM', message='Generated by GNU Radio', program_types=[nrsc5.program_type.NEWS], latitude=40.6892, longitude=(-74.0445), altitude=93.0, country_code='US', fcc_facility_id=0)
